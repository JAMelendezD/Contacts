...
def run():
	...
	acceptor2 = u.select_atoms('bynum 6558:13114 and name O*', 'bynum 6558:13114 and name N*')
	donor2 = u.select_atoms('bynum 6558:13114 and name O* and bonded name H*', 'bynum 6558:13114 and name N* and bonded name H*')
